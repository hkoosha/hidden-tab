 ...
 *   handlers = {
 *     "list_builder" =
 *   "Drupal\hidden_tab\Entity\HiddenTabPlacementListBuilder",
 *     "access" =
 *   "Drupal\hidden_tab\Entity\HiddenTabPlacementAccessControlHandler",
 *     "form" = {
 ...
 *     "edit-form" =
 *   "/admin/structure/hidden-tab-placement/{hidden_tab_placement}",
 *     "delete-form" =
 *   "/admin/structure/hidden-tab-placement/{hidden_tab_placement}/delete"
 *   },
 *   entity_keys = {
 *     "id" = "id",
 *     "uuid" = "uuid"
