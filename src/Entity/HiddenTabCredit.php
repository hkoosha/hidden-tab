 ...
 *     "access" =
 *   "Drupal\hidden_tab\Entity\HiddenTabCreditAccessControlHandler",
 *     "form" = {
 ...
 *   admin_permission = "administer hidden tab credit",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "id",
 *     "uuid" = "uuid"
...
class HiddenTabCredit extends ContentEntityBase implements HiddenTabCreditInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields += FUtility::refrencerEntityFields('node', t('Node'),
      FUtility::nodeBundlesSelectList());
    ...
    $fields['low_credit_inline_template'] =
      FUtility::textArea('Low Credit Inline Twig Template');
    $fields['is_per_ip'] =
   ...
   *   The form elements.
   */
  public static function littleForm(string $prefix = '',
  ...
  public static function extractFormValues(string $prefix,
    ...
    if (!$v['low_credit_template']) {
      foreach (HiddenTabTemplatePluginManager::man()
  ...
  public static function validateForm(FormStateInterface $form_state,
    ...
    try {
      ...
      \Drupal::logger('hidden_tab')
        ->error('Error while validating Hidden Tab Credit creation, msg={msg} trace={trace}', [
