 ...
 *   admin_permission = "administer hidden_tab_page",
 *   links = {
 ...
 *     "delete-form" =
 *   "/admin/structure/hidden-tab-page/{hidden_tab_page}/delete"
 *   },
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "label",
...
class HiddenTabPage extends ConfigEntityBase implements HiddenTabPageInterface {
  ...
  public function creditCheckOrder(): array {
    return !$this->credit_check_order
      ? CreditCharging::fixCreditCheckOrder(HiddenTabPageForm::DEFAULT_CREDIT_CHECK_ORDER)
      : CreditCharging::fixCreditCheckOrder($this->credit_check_order);
  }
