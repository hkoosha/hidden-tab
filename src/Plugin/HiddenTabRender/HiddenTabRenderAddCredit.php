...
class HiddenTabRenderAddCredit extends HiddenTabRenderAdministrativeBase {
   ...
   */
  protected static $PID = 'hidden_tab_add_credit';
   ...
   */
  protected static $HTPLabel = 'Add Credit';
   ...
   */
  protected static $HTPDescription = 'Displays an add credit form on a hidden tab page.';
  ...
  protected function render0(EntityInterface $entity,
    ...
    try {
      ...
      \Drupal::logger('hidden_tab')
        ->error('error while creating on page add credit form page={page} entity={entity} entity-type={type} user={user} msg={msg} trace={trace}', [
          'page' => $page->id(),
          'entity' => $entity->id(),
  ...
  protected function render1(EntityInterface $entity,
    ...
    $form = $this->formBuilder->getForm(
      OnPageAddCreditForm::class, $entity, $page);
