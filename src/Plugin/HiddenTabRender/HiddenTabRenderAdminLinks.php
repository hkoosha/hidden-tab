...
class HiddenTabRenderAdminLinks extends HiddenTabRenderAdministrativeBase {
   ...
   */
  protected static $PID = 'hidden_tab_admin_links';
   ...
   */
  protected static $HTPLabel = 'Admin Links';
   ...
   */
  protected static $HTPDescription = 'Displays a set of administrative links on a hidden tab page.';
  ...
  protected function render0(EntityInterface $entity,
    ...
    $p = HiddenTabTemplatePluginManager::man()
    ...
    $layout = Link::createFromRoute($this->t('<h2>Layout</h2>'), 'entity.hidden_tab_page.layout_form', [
      ...
      ->toRenderable();
    $pages = Link::createFromRoute($this->t('<h2>Pages</h2>'), 'entity.hidden_tab_page.collection')
      ->toRenderable();
    $credits = Link::createFromRoute($this->t('<h2>Credits</h2>'), 'entity.hidden_tab_credit.collection')
      ->toRenderable();
