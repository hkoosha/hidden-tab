...
class HiddenTabMailDiscoveryByEmailField extends HiddenTabMailDiscoveryPluginBase {
   ...
   */
  protected static $PID = 'hidden_tab_by_email_field';
   ...
   */
  protected static $HTPLabel = 'By Email Field';
  ...
  public function findMail(HiddenTabMailerInterface $config,
    ...
    $field_name = $config->pluginConfiguration($this->id());
    // TODO FIX ME!!
  ...
  public function handleConfigForm(array &$form, ?FormStateInterface $form_state, $config) {
    ...
    $form[static::$PID . '__discovery_field'] = [
      '#type' => 'select',
      '#title' => t('Email By text'),
   ...
   * {@inheritdoc}
   */
  public function handleConfigFormSubmit(?array &$form, FormStateInterface $form_state, $config): string {
    return $form_state->getValue(static::$PID . '__discovery_field');
  }
